...
class release_3_0_0_schema extends \phpbb\db\migration\migration
{
	...
	{
		return array('\privet\ailabs\migrations\v2x\release_2_0_0_schema');
	}

	public function effectively_installed()
	{
		return isset($this->config['privet_ailabs_version']) && version_compare($this->config['privet_ailabs_version'], '3.0.0', '>=');
	}
